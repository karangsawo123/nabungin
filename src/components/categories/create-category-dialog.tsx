...
export function CreateCategoryDialog({
  ...
  const [selectedIcon, setSelectedIcon] = React.useState('tag')
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setErrorMsg('Terjadi kesalahan koneksi saat membuat kategori.')
    } finally {
      setIsLoading(false)
    }
  }
    ...
    <Dialog isOpen={isOpen} onClose={handleClose}>
      <form onSubmit={handleSubmit}>
        <DialogHeader>
          ...
          <DialogTitle>Tambah Kategori Pos Tabungan</DialogTitle>
          <DialogDescription>
            Klasifikasikan pos alokasi dana dan transaksi untuk mempermudah monitoring keuangan.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              id="category-name"
              placeholder="Contoh: Belanja Bulanan / Tabungan Haji"
              value={name}
